...
module Ai
  class AssistantService
      ...
      Mcp::Server::TOOLS.map do |name, tool_class|
        {
          ...
          input_schema: tool_class::SCHEMA
        }
      end
    rescue => e
    ...
    def system_prompt
      <<~PROMPT
        You are an AI assistant for Reflex, the webhook management system. You help users manage webhook endpoints, view delivery logs, and troubleshoot webhook issues.
